...
class ExportPdfP3K extends StatefulWidget {
  final String monthYear;

  const ExportPdfP3K({super.key, required this.monthYear});

  @override
  State<ExportPdfP3K> createState() => _ExportPdfP3KState();
}

class _ExportPdfP3KState extends State<ExportPdfP3K> {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          final tablePdf = await PdfService.generatePdf(
              date: '$nowMonth $nowYear', kategori: 'PENGGUNAAN P3K');
